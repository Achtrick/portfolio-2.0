    ...
    >
      <section className={styles.intro}>
        ...
        <div className={styles.row}>
          ...
          >
            <h1>{t("marketing_intro_title")}</h1>
            <h2>{t("marketing_intro_desc")}</h2>
          </div>
          <div className={styles.col50}>
            ...
            >
              <img alt="service_Img" src={"/" + "./images/marketing.webp"} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className={styles.section2}>
        ...
        >
          <div className={styles.col}>
            ...
            <h1>{t("marketing_title3")}</h1>
            {/* <p>{t("marketing_desc3")}</p> */}
          </div>
        </div>
        <div
          data-aos="fade-down"
        ...
        >
          <div className={styles.col}>
            ...
            <h1>{t("marketing_title4")}</h1>
            {/* <p>{t("marketing_desc4")}</p> */}
          </div>
        </div>
        <div
          data-aos="fade-down"
        ...
        >
          <div className={styles.col}>
            <div className={styles.imgHolder}>
              <img alt="service_Img" src={"/" + "./icons/parle.webp"} />
            </div>
            <h1>{t("marketing_title5")}</h1>
            {/* <p>{t("marketing_desc5")}</p> */}
          </div>
        </div>
        <div
          data-aos="fade-down"
        ...
        >
          <div className={styles.col}>
            ...
            <h1>{t("marketing_title6")}</h1>
            {/* <p>{t("marketing_desc6")}</p> */}
          </div>
        </div>
      </section>

        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Creo Digital, Rue constantine, La
              corniche, Sousse 4000, Tunisie.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Creo, accessible from{" "}
              <Link href="https://www.creo.tn" rel="noreferrer" target="_blank">
                https://www.creo.tn
              </Link>
            </p>
          </li>
        ...
        <ul>
          <li>
            <p>
              ...
              <Link
                ...
                class="__cf_email__"
                data-cfemail="d9bab6b7adb8baad99baabbcb6f7adb7"
              >
                [email&#160;protected]
              </Link>
            </p>
          ...
          <li>
            <p>
              ...
              <Link href="https://creo.tn" rel="noreferrer" target="_blank">
                https://creo.tn
              </Link>
            </p>
          </li>

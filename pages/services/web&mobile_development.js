    ...
    >
      <section className={styles.intro}>
        ...
        <div className={styles.row}>
          ...
          >
            <h1>{t("web&mob_dev_intro_title")}</h1>
            <h2>{t("web&mob_dev_intro_desc")}</h2>
          </div>
          <div className={styles.col50}>
            ...
            >
              <img alt="service_Img" src={"/" + "./images/code.svg"} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className={styles.section2}>
        ...
        >
          <div className={styles.col}>
            ...
            <h1>{t("web&mob_dev_title3")}</h1>
            {/* <p>{t("web&mob_dev_desc3")}</p> */}
          </div>
        </div>
        <div
          data-aos="fade-down"
        ...
        >
          <div className={styles.col}>
            ...
            <h1>{t("web&mob_dev_title4")}</h1>
            {/* <p>{t("web&mob_dev_desc4")}</p> */}
          </div>
        </div>
        <div
          data-aos="fade-down"
        ...
        >
          <div className={styles.col}>
            <div className={styles.imgHolder}>
              <img alt="service_Img" src={"/" + "./icons/deve.webp"} />
            </div>
            <h1>{t("web&mob_dev_title5")}</h1>
            {/* <p>{t("web&mob_dev_desc5")}</p> */}
          </div>
        </div>
        <div
          data-aos="fade-down"
        ...
        >
          <div className={styles.col}>
            ...
            <h1>{t("web&mob_dev_title6")}</h1>
            {/* <p>{t("web&mob_dev_desc6")}</p> */}
          </div>
        </div>
        <div
          data-aos="fade-down"
        ...
        >
          <div className={styles.col}>
            <div className={styles.imgHolder}>
              <img alt="service_Img" src={"/" + "./icons/maintenance.webp"} />
            </div>
            <h1>{t("web&mob_dev_title7")}</h1>
            {/* <p>{t("web&mob_dev_desc7")}</p> */}
          </div>
        </div>
      </section>
